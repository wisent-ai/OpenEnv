...
\textsc{KantBench} is implemented as an OpenEnv-compatible
...
instances. Internally, the \texttt{KantBenchEnvironment} class
...
managed by the \texttt{KantBenchEnv} client class. The client
