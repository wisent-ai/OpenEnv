...
\textsc{MachiaveliBench}, a game-theory benchmark built on the OpenEnv
...
evaluation protocol, \textsc{MachiaveliBench} provides a reproducible
...
We present \textsc{MachiaveliBench}, a lightweight, standardized
...
\textsc{MachiaveliBench} integrates with the OpenEnv framework, exposing
